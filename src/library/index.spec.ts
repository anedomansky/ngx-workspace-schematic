...
describe('library schematic', () => {
  ...
  it('should create all files (no scope)', async () => {
    ...
    expect(tree.files).toContain(
      '/projects/test-lib/src/lib/sample/sample.html',
    );
    expect(tree.files).toContain(
      '/projects/test-lib/src/lib/sample/sample.scss',
    );
    expect(tree.files).toContain(
      '/projects/test-lib/src/lib/sample/sample.spec.ts',
    );
    expect(tree.files).toContain('/projects/test-lib/src/lib/sample/sample.ts');
    expect(tree.files).toContain(
  ...
  it('should create all files (with scope)', async () => {
    ...
    expect(tree.files).toContain(
      '/projects/test/test-lib/src/lib/sample/sample.html',
    );
    expect(tree.files).toContain(
      '/projects/test/test-lib/src/lib/sample/sample.scss',
    );
    expect(tree.files).toContain(
      '/projects/test/test-lib/src/lib/sample/sample.spec.ts',
    );
    expect(tree.files).toContain(
      '/projects/test/test-lib/src/lib/sample/sample.ts',
    );
    expect(tree.files).toContain(
